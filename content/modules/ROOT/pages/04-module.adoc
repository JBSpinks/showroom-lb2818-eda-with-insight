...
.. Go to *Automation Decisions → Rulebook Activations* and Observe - *RH Insights rulebook* Rulebook Activations *Fire Count* has been increased.
+
****
.Rulebook Activation
...
Upon receiving an event on Malware being detected, Ansible Automation Platform runs a playbook.

This playbook doesn't really do much today, but you could create a playbook that follows the policies and procedures of your organization in the event that malware is detected.
